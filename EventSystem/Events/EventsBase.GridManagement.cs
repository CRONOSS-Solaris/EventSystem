            ...
            MyAPIGateway.Utilities.InvokeOnGameThread(() =>
            {
                try
                {
                    ...
                    var safezoneDefinition = new MyObjectBuilder_SafeZone
                    {
                        ...
                        Enabled = isEnabled,
                        AccessTypePlayers = (Sandbox.Common.ObjectBuilders.MySafeZoneAccess)accessTypePlayers,
                        AccessTypeFactions = (Sandbox.Common.ObjectBuilders.MySafeZoneAccess)accessTypeFactions,
                        AccessTypeGrids = (Sandbox.Common.ObjectBuilders.MySafeZoneAccess)accessTypeGrids,
                        AccessTypeFloatingObjects = (Sandbox.Common.ObjectBuilders.MySafeZoneAccess)accessTypeFloatingObjects,
                        AllowedActions = (VRage.Game.ObjectBuilders.Components.MySafeZoneAction)allowedActions,
                        ModelColor = color,
                        Texture = texture,
                        IsVisible = isVisible,
