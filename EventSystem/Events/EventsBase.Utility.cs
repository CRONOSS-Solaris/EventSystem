...
namespace EventSystem.Events
{
    public abstract partial class EventsBase
    {
        ...
        private string _configPath = Path.Combine(EventSystemMain.Instance.StoragePath, "EventSystem", "EventTechnical_ReadOnly", "EntityIDs.json");
